...
::
        ...
        $ dmsetup create dust1 --table '0 33552384 dust /dev/vdb1 0 512'

(For a device with a block size of 4096 bytes)

::

        $ dmsetup create dust1 --table '0 33552384 dust /dev/vdb1 0 4096'
...
bad block additions, removals, and remaps will be verbosely logged)::
        ...
        $ dd if=/dev/mapper/dust1 of=/dev/null bs=512 count=128 iflag=direct
        128+0 records in
        128+0 records out
...
block will encounter an "Input/output error"::
        ...
        $ dd if=/dev/mapper/dust1 of=/dev/null bs=512 count=1 skip=67 iflag=direct
...
result in an "Invalid argument" error, as well as a helpful message::
        ...
        $ dmsetup message dust1 0 addbadblock 88
...
result in an "Invalid argument" error, as well as a helpful message::
        ...
        $ dmsetup message dust1 0 removebadblock 87
        device-mapper: message ioctl on dust1  failed: Invalid argument
...
following message command::
        ...
        $ dmsetup message dust1 0 queryblock 72
