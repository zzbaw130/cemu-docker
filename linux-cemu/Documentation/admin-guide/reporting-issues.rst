...
are running a kernel you compiled yourself earlier, call it like this::
       ...
       [user@something ~]$ dmesg | ./linux-5.10.5/scripts/decode_stacktrace.sh ./linux-5.10.5/vmlinux
...
like this::
       ...
       [user@something ~]$ dmesg | ./linux-5.10.5/scripts/decode_stacktrace.sh \
 ...
 * Gather additional information from the kernel that might be of interest. The
   ...
   make the output from ``lspci -vvv`` available, as that provides
