...
file system ACLs [10]_ and [15]_ utility can be used to create
...
1. Create shell script that uses capsh utility [16]_ to assign CAP_PERFMON
   ...
   the process identity to caller of the script who should essentially
...
2. Extend policy at /etc/sudoers file with a rule for perf_users group:
