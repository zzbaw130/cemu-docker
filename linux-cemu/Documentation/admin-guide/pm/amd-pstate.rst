...
Or generate trace file with root privilege, then parse and plot with command ::
 ...
 ./amd_pstate_trace.py [-c cpus] -n <test_name> -i <interval> [-m kbytes]
...
#. How to execute the tests
   ...
   details refer to Linux Kernel Selftests [4]_).
    ...
    2). Installation & Steps ::
        ...
        $ ./kselftest/run_kselftest.sh -c amd-pstate
    ...
    3). Specified test case ::
        ...
        $ ./run.sh -t basic
        $ ./run.sh -t tbench
        $ ./run.sh -t tbench -m acpi-cpufreq
        $ ./run.sh -t gitsource
        $ ./run.sh -t gitsource -m acpi-cpufreq
        $ ./run.sh --help
