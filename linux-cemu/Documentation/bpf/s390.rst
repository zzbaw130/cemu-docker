...
Users of other distros may use debootstrap in order to set up a Debian chroot::
  ...
  debootstrap \
    ...
    testing \
    ./s390-toolchain
  mount --rbind /dev ./s390-toolchain/dev
  mount --rbind /proc ./s390-toolchain/proc
  mount --rbind /sys ./s390-toolchain/sys
  chroot ./s390-toolchain
