...
def print_help(driver_name):
    ...
    print('  Usage:')
    print('    If the trace file is available, then to simply parse and plot, use (not required):')
    ...
    print('    To generate trace file, parse and plot, use (required):')
    print('      ./%s_tracer.py [-c cpus] -i <interval> -n <test_name> -m <kbytes>'%driver_name)
    print('    Or')
    print('      ./%s_tracer.py [--cpu cpus] --interval <interval> --name <test_name> --memory <kbytes>'%driver_name)
