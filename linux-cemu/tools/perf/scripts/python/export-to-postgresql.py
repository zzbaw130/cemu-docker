...
# fedora:
#
#	$ yum install postgresql postgresql-server qt-postgresql
...
#	$ apt-get install python-pyside.qtsql libqt4-sql-psql
#
#	Alternately, to use Python3 and/or pyside 2, one of the following:
#
#		$ apt-get install python3-pyside.qtsql libqt4-sql-psql
#		$ apt-get install python-pyside2.qtsql libqt5sql5-psql
#		$ apt-get install python3-pyside2.qtsql libqt5sql5-psql
#
