...
To compile and flash an SD card image::
  ...
  make ls1021atsn_sdcard_defconfig && make -j 8 && cp u-boot-with-spl-pbl.bin /srv/tftpboot/
...
(https://source.codeaurora.org/external/qoriq/qoriq-components/rcw)::
  ...
  make -j 8 && cp ls1021atsn/SSR_PNS_30/rcw_1200_qspiboot.bin.swapped /srv/tftpboot/
...
To compile and flash a U-Boot image for QSPI::
  ...
  make ls1021atsn_qspi_defconfig && make -j 8 && cp u-boot.bin /srv/tftpboot/
