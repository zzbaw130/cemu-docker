...
Program the flash::
        ...
        fastboot -i 0x2207 flash loader1 idbloader.img
        fastboot -i 0x2207 flash loader2 u-boot.itb
...
.. code-block:: none
  ...
  dd if=trust.img of=/dev/sda seek=24576
...
.. code-block:: none
  ...
  dd if=uboot.img of=/dev/sda seek=16384
