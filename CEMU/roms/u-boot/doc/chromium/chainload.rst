...
Steps::
   ...
   cgpt create $DISK
   cgpt add -b 34 -s 32768 -P 1 -S 1 -t kernel $DISK
   cgpt add -b 32802 -s 2000000 -t rootfs $DISK
   gdisk $DISK   # Enter command 'w' to write a protective MBR to the disk
...
Steps::
   ...
   dd if=u-boot.kpart of=/dev/sdc1; sync
