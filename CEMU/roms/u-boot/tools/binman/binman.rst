...
First install prerequisites, e.g::
    ...
    apt-get install python-pyelftools python3-pyelftools lzma-alone \
        liblz4-tool
...
To enable Python test coverage on Debian-type distributions (e.g. Ubuntu)::
   ...
   $ apt-get install python-coverage python3-coverage python-pytest
...
all available CPUs to run.
 ...
 To enable this::
   ...
   $ apt-get install python-subunit python3-subunit
